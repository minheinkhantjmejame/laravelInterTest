    ...
    <div class="application_info_container">
        ...
        <div class="buttons info-row">
            ...
            <div class="status-card">
                <h4 data-translate="ACCEPTANCE TERMS">ACCEPTANCE TERMS</h4>
                <div class="status-description">
                    ...
                    <p><span data-translate="We have received your document!">We have received your document!</span> <br/><span data-translate="Please wait to proceed to the next step in a few days.">Please wait to proceed to the next step in a few days.</span></p>
                </div>
            </div>
        </div>
@endsection
