...
<div class="application_info_container">
    ...
    <div class="buttons info-row">
        ...
        <div>
            <a href="./request_internship_application.html"><button class="button button status-button-color" style="color:#fff;">2</button></a>
            <p>Request Internship Application</p>
        </div>
        
        <div>
            <a href="./request_internship_document_success.html"><button class="button">3</button></a>
